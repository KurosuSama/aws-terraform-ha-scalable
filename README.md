...
Provisioning of a highly available AWS infrastructure with dynamic scaling policies using Terraform for infrastructure and Ansible for configuration management.
